...
type MusicApiClient interface {
	...
	GetTrack(ctx context.Context, in *Url, opts ...grpc.CallOption) (*TrackWithAlbumAndArtists, error)
...
func (c *musicApiClient) GetArtist(ctx context.Context, in *Url, opts ...grpc.CallOption) (*ArtistWithAlbums, error) {
	...
	err := c.cc.Invoke(ctx, "/music_api.MusicApi/GetArtist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *musicApiClient) GetAlbum(ctx context.Context, in *Url, opts ...grpc.CallOption) (*AlbumWithTracks, error) {
	...
	err := c.cc.Invoke(ctx, "/music_api.MusicApi/GetAlbum", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *musicApiClient) GetTrack(ctx context.Context, in *Url, opts ...grpc.CallOption) (*TrackWithAlbumAndArtists, error) {
	out := new(TrackWithAlbumAndArtists)
	err := c.cc.Invoke(ctx, "/music_api.MusicApi/GetTrack", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MusicApiServer interface {
	...
	GetTrack(context.Context, *Url) (*TrackWithAlbumAndArtists, error)
...
func (UnimplementedMusicApiServer) GetTrack(context.Context, *Url) (*TrackWithAlbumAndArtists, error) {
...
func _MusicApi_GetArtist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/music_api.MusicApi/GetArtist",
	}
...
func _MusicApi_GetAlbum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/music_api.MusicApi/GetAlbum",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MusicApi_GetTrack_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/music_api.MusicApi/GetTrack",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
